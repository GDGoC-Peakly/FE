    ...
    if (isEditMode) {
      try {
        ...
        const payload = {
          ...
          sleepScore: Number(conditionData.value / 25 + 1), 
        };

        console.log("PATCH Sleep Time:", payload);
        ...
        console.log("Edit Failure:", error.response?.data || error.message);
        Alert.alert("저장 실패", "숙면 시간을 수정하지 못했습니다.");
      }
    } else {
      setSleepData(updatedSleep);
